...
0. 번역문은 순수 한국어만 사용하세요 — 한자·중국어·일본어 문자는 절대 쓰지 마세요(숫자는 예외). 원문에 등장하는 지명·인명이 한자나 가나로 표기되어 있어도, 통용되는 한국어 표기로 옮기세요(고유명사를 원문의 로마자/한글 그대로 유지하는 것은 허용되지만 한자·가나로는 절대 남기지 마세요).
